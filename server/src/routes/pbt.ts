...
router.post('/inputs', requireAuth, asyncHandler(async (req, res) => {
  ...
  const additionalIndirectExpense = validateExpenseValue(
    req.body.additionalIndirectExpense ?? req.body.indirectExpense,
    'Additional indirect expense',
  );
