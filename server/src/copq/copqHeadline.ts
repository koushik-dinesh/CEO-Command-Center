...
export function extractCopqHeadline(normalized: Record<string, unknown>): Record<string, unknown> {
  return {
...
export function copqHeadlineToSourceRecord(headline: Record<string, unknown>): { sourceDate: Date; normalized: Record<string, unknown> } {
  return {
    sourceDate: new Date(),
    normalized: headline,
  };
