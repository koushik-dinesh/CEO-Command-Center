...
function revenueTotals(context: KpiCalculationContext) {
...
function inventorySnapshots(context: KpiCalculationContext): Map<string, Decimal> {
  const snapshots = new Map<string, Decimal>();
