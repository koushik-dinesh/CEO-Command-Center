...
import { calculateProductivityIndex, enumerateCalendarMonths, financialYearFromCalendar, financialYearLabel, monthsForMtd, monthsForQtd, monthsForYtd, sumHrExpenses, validateHrExpenseValue, } from '../src/productivity/productivityUtils.js';
function hrRecord(month, calendarYear, hrExpense) {
    return {
